...
from AlgorithmPool.NetPool.NetFrame.blocks import PlainBlock, ResidualBlock, InceptionBlock, Upsample
    ...
    def __init__(self, input_channels, channels_list,
        ...
        for l, num_channels in enumerate(self.channels_list):
            ...
            blocks = nn.Sequential(
                block(in_channels, out_channels, stride=(first_stride,first_stride,first_stride), **block_kwargs),
