...
class PlainBlock(nn.Module):
    def __init__(self, input_channels, output_channels, stride=(1, 1, 1), kernel_size=3,
...
if __name__ == "__main__":
    ...
    x = torch.randn(5, 4, 24, 256, 256)
    incep_block = InceptionBlock(4, 4, kernel_size=(3, 3, 3), stride=(2, 2, 2), norm_key='instance',
                                 dropout_prob=None)
    out = incep_block(x)
    print(out.shape)
